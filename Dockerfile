...
COPY ["Tasko.General/Tasko.General.csproj", "Tasko.General/"]
RUN dotnet workload restore "Tasko.UserService/Tasko.UserService.csproj"
COPY . .
WORKDIR "/app/Tasko.UserService"
